...
<body>
    <h1 align="center">Formulir Pendaftaran Peserta Didik</h1>
    <form method="post">
        <table align="center">
            <tr>
                <td>No Daftar</td>
    ...
    <table align="center" border="1">
        ...
        <tr>
            ...
            <td><a href="cetak-perorang.php?id=<?php echo $r['id'] ?>" class="btn btn-secondary btn-sm" target="_blank">CETAK</a></td>
        </tr>
        <?php } } ?>
    </table>
</body>
